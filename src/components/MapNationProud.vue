...
<script>
    import jsonData from '../data/NationProud';
    ...
    for (let i = 0; i < country_list.length; i++) {
        ...
        let element = {
            ...
            "linkedchart": {
                ...
                "dataset": [
                    {
                        "seriesname": "Very proud",
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Very proud"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Very proud"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Very proud"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Very proud"]
                            }
                        ]
                    },
                    {
                        "seriesname": "Quite proud",
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Quite proud"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Quite proud"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Quite proud"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Quite proud"]
                            }
                        ]
                    },
                    {
                        "seriesname": "Not very proud",
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Not very proud"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Not very proud"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Not very proud"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Not very proud"]
                            }
                        ]
                    },
                    {
                        "seriesname": "Not at all proud",
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Not at all very proud"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Not at all very proud"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Not at all very proud"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Not at all very proud"]
                            }
                        ]
                    },
                    {
                        "seriesname": "I am not [nationality]",
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["I am not [nationality]"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["I am not [nationality]"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["I am not [nationality]"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["I am not [nationality]"]
                            }
                        ]
                    },
                    {
    ...
    export default {
        data() {
            return {
                ...
                dataSource: {
                    "chart": {
                        "caption": "World-wide Situation of How Proud of Nationality",
