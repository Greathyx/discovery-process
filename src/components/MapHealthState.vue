...
<script>
    import jsonData from '../data/HealthState';
                ...
                "dataset": [
                    {
                        ...
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Very good"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Very good"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Very good"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Very good"]
                            }
                        ]
                    },
                    {
                        ...
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Good"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Good"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Good"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Good"]
                            }
                        ]
                    },
                    {
                        ...
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Fair"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Fair"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Fair"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Fair"]
                            }
                        ]
                    },
                    {
                        ...
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Poor"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Poor"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Poor"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Poor"]
                            }
                        ]
                    },
                    {
                        "seriesname": "Very poor",
                        "data": [
                            {
                                "value": i_1995_1999 === -1 ? 0 : jsonData["1995_1999"][i_1995_1999]["Very poor"]
                            },
                            {
                                "value": i_2000_2004 === -1 ? 0 : jsonData["2000_2004"][i_2000_2004]["Very poor"]
                            },
                            {
                                "value": i_2005_2009 === -1 ? 0 : jsonData["2005_2009"][i_2005_2009]["Very poor"]
                            },
                            {
                                "value": i_2010_2014 === -1 ? 0 : jsonData["2010_2014"][i_2010_2014]["Very poor"]
                            }
                        ]
                    },
                    {
    ...
    export default {
        data() {
            return {
                ...
                dataSource: {
                    "chart": {
                        "caption": "World-wide Situation of State of Health",
